...
| ADR-05 | 2026-03-28 | Dynamic Page Restrictions Table | Create `page_restrictions` table to toggle beta/in-dev pages. Hides pages and sidebar links from non-owners and redirects them to /home. | Accepted |
