        ...
        <div className="space-y-8 animate-fade-in max-w-none">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-black text-brand-charcoal tracking-tight">Supplier Returns</h1>
                        <p className="text-sm text-slate-500 mt-1 font-medium">Track items sent back to suppliers and manage inventory adjustments</p>
                    </div>
                </div>
                <button
                ...
                <div className="flex-shrink-0 w-full lg:w-72">
                    <div className="sticky top-6 space-y-4">
                        ...
                        <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm overflow-hidden relative">
                            ...
                            <h3 className="text-[10px] font-black text-brand-charcoal border-b border-slate-100 pb-3 mb-4 uppercase tracking-[0.2em]">Return Statistics</h3>
                            <div className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-1">Total Returns</p>
                                        <p className="text-lg font-black text-brand-charcoal font-data">{stats.totalReturns}</p>
                                    </div>
                                    <div>
                                ...
                                <div className="pt-3 border-t border-slate-100">
                                    <p className="text-[9px] font-black text-slate-800 uppercase tracking-widest mb-1">Total Return Value</p>
